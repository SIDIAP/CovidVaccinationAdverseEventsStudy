...
WHERE (C.measurement_date >= DATEFROMPARTS(2020, 9, 1) and C.measurement_date <= DATEFROMPARTS(2021, 2, 28))
...
WHERE (C.measurement_date >= DATEFROMPARTS(2020, 1, 1) and C.measurement_date <= DATEFROMPARTS(2020, 8, 31))
