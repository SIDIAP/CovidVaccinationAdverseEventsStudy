...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (35891709)

) I
) C UNION ALL 
SELECT 1 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (35891522)
...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2020, 12, 8) and C.drug_exposure_start_date <= DATEFROMPARTS(2021, 3, 6))
